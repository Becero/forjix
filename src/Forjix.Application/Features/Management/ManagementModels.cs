...
public sealed record PagedAudit(IReadOnlyList<AuditItem> Items, int Page, int PageSize, int Total);
...
public sealed record PagedProducts(IReadOnlyList<ProductItem> Items, int Page, int PageSize, int Total);
