...
public interface IManagementService
{
    ...
    Task<IReadOnlyList<AuditItem>> GetAuditAsync(Guid? userId, string? action, string? entity, DateTimeOffset? from, DateTimeOffset? toDate, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<ProductItem>> GetProductsAsync(string? search, Guid? categoryId, bool? isActive, CancellationToken cancellationToken = default);
