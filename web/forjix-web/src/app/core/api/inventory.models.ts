...
export interface InventoryItem { productId: string; productName: string; sku: string; barcode?: string; categoryId: string; categoryName: string; quantity: number; minimumStock: number; costPrice: number; status: InventoryStatus; lastMovementAt?: string; rowVersion: string; }
